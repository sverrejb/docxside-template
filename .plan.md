...
This logic is too complex to inline in the generated code via `quote!`. Instead, I'll add a **runtime helper function** to the library that the generated `save()` calls. The proc-macro crate can re-export it since test-crate already depends on `docxside-templates`.
